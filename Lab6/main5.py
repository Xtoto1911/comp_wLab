...
listP = ['sil1.png', 'sil2.png', 'sil3.png', 'sil4.png', 'sil5.png']
colors = [(64, 255, 64), (64, 64, 255), (255, 64, 64), (255, 255, 64), (64, 255, 255)]
copy = image.copy()

for path, color in zip(listP, colors):
    print("Имя образца:",path)
